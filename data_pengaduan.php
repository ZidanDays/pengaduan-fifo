...
if ($cari != ''){
    // Saat admin melakukan pencarian, data yang ditemukan tetap diurutkan berdasarkan prinsip FIFO
    $query = mysqli_query($conn, "SELECT * FROM pengaduan WHERE 
            nama_pengadu LIKE '%".$cari."%' OR 
            nik LIKE '%".$cari."%' OR 
...
<tr>
    ...
    <td>
        <form method="post" action="edit_selesai.php?id=<?php echo $data['id_pengaduan'] ?>" style="margin:0;">
            ...
            <div class="dropdown" style="display:inline-block;">
                <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs" aria-hidden="true"></i></button>
