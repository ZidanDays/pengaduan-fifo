                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://g.co/kgs/EYrCRP7" style="color:white"><i class="fa fa-podcast"> Kantor Dinas Lingkungan Hidup Cek Disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> lingkunganhidup@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>+6285601198</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di website Pengaduan Masyarakat<br>
                                    Silahkan Daftar dan Login dengan akun anda.</p>
                                <div class="video_service_btn">
                                    <a href="registrasi.php" class="boxed-btn3"><i class="fa fa-user-plus"> Daftar Disini</i></a>
...
<div class="floatwa">
<a href="https://api.whatsapp.com/send?phone=62895357219911&amp;text=Halo%20ADMIN,%20Saya%20mau%20Lapor,saya lupa akun" target="_blank"><div class="tombolwa">LUPA PASSWORD?SILAHKAN LAPOR DISINI!</div></a></div> 
</body>
